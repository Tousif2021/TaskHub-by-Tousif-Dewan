import { Home, FolderDot, ListTodo, Bell, User, ArrowLeft } from "lucide-react";
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-slate-900/90 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="flex justify-around items-center h-16">
          {/* Moved back button to the header as requested */}
          {showBackButton && (
            <Link
              to="/"
          ...
          <NavItem icon={ListTodo} label="Task Preview" to="/tasks" active={location.pathname === "/tasks"} /> {/* Changed "Add Task" to "Task Preview" */}
